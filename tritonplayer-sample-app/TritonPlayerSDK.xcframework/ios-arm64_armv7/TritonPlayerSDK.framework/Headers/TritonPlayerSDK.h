...
//! Project version number for TritonPlayerSDK.
FOUNDATION_EXPORT double TritonPlayerSDKVersionNumber;

//! Project version string for TritonPlayerSDK.
FOUNDATION_EXPORT const unsigned char TritonPlayerSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <TritonPlayerSDK/PublicHeader.h>
